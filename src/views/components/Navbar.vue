  ...
  <div data-collapse="small" data-animation="default" data-duration="400" class="navbar w-nav">
    ...
    <div class="container w-container">
      <div class="w-full flex flex-row">
        ...
        <router-link to="/" class='no-underline flex-grow inline text-xl text-gray-900 font-bold'>Recurified</router-link>
       </div>
       ...
       <div class="inline-block lg:hidden  pull-right p-4"  >
        ...
        <div v-if="showResponsiveMenu" class="w-full absolute z-10 left-0 block flex-grow lg:flex lg:items-center lg:w-auto bg-gray-200">
